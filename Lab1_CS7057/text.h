...
bool init_text_rendering (const char* font_image_file,const char* font_meta_data_file,int viewport_width,int viewport_height);
...
int add_text (const char* str,float x,float y,float size_in_px,float r,float g,float b,float a);
...
bool hide_text(int id);

bool unhide_text(int id);
//
